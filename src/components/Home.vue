<template>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">基础信息</h4>
                  </div>
                  <div class="modal-body">
                    <form>
                      <div class="form-group">
                        <label for="name">名称</label>
                        <input type="text" class="form-control" v-model="addForm.name" placeholder="名称">
                      </div>
                      <div class="form-group">
                        <label for="count">数量</label>
                        <input type="text" class="form-control" v-model="addForm.count" placeholder="数量">
                      </div>
                      <div class="form-group">
                        <label for="date">日期</label>
                        <date-picker field="myDate" placeholder="选择日期" :value.sync="addForm.date" format="yyyy/mm/dd"
                        :backward="false" :no-today="true" :forward="true">
                        </date-picker>
                      </div>
                    </form>
                  </div>
  ...
  export default {
    ...
    components: {
      Pagination, 'date-picker': myDatepicker
    },
    vuex: {
      getters: {
